...
if(isset($_POST['submit'])){
    ...
    if (!empty($user)) {
        $_SESSION['creation_message'] = "New user: " . $user->username . " was added to the Database! You may now log in.";
...
<div class="row h-100">
    <div class="col-lg-5 col-12">
        <div id="auth-left">
            <div class="auth-logo">
                <a href="admin/index.php"><img src="admin/assets/compiled/svg/logo.svg" alt="Logo"></a>
            </div>
            ...
            <div class="text-center mt-5 text-lg fs-4">
                <p class='text-gray-600'>Already have an account? <a href="admin/auth-login.html" class="font-bold">Log
                        in</a>.</p>
            </div>
        </div>
    </div>
